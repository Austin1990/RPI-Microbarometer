...
class BMP280():
    ...
    def __init__(self, port=1, mode=NORMAL_MODE, oversampling_p=OVERSAMPLING_P_x4, 
                 oversampling_t=OVERSAMPLING_T_x1, filter=IIR_FILTER_x4, standby=T_STANDBY_4000):
        self.bus = SMBus(port)
    ...
    def read_temperature(self):
        ...
        # 20 bit format stored in a 32 bit signed integer
